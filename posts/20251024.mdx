...
현재 PPR은 `next@canary` 로만 확인할 수 있는 **실험 단계의 기능**이지만, Next.js 팀이 매우 적극적으로 개발하고 있습니다. 이는 미래 웹 성능의 방향성을 보여주는 중요한 신호라고 생각합니다.
...
https://nextjs.org/docs/app/getting-started/cache-components#cache-components