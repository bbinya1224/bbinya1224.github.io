...
date: "2025-11-25"
slug: "20251125"
tag: "Side Project, AI, PRD, Product"
category: "사이드프로젝트"
description: "사이드프로젝트를 진행 일지, 첫번째 페이지 입니다. ✨"
---

import Mermaid from "@/islands/lab/Mermaid/Mermaid";
...
<Mermaid client:only="react" chart={`
flowchart TD
...
<Mermaid client:only="react" chart={` sequenceDiagram participant Client participant API as /api/generate-review participant Search as Tavily API participant FS as File System participant AI as Claude Haiku
