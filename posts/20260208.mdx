...
### <mark>Zustand: "Store 하나로 단순하게"</mark>
...
### <mark>Jotai: "Atom 단위로 쪼개서 조합"</mark>
...
### <mark>Redux Toolkit: "예측 가능한 단방향 흐름"</mark>
...
### Zustand: <mark>selector 기반 구독</mark>
...
### Redux Toolkit: <mark>`useSelector` + 메모이제이션</mark>
