...
const Header = () => {
  ...
  return (
    <header
      className={`dark:bg-primary fixed top-0 left-1/2 z-50 mx-8 h-[4.5rem] w-[calc(100%-4rem)] max-w-[var(--page-width)] -translate-x-1/2 rounded-2xl rounded-t-none bg-white px-8 py-2 text-black shadow-lg transition-transform duration-300 ease-out dark:text-white ${isVisible ? "translate-y-0" : "-translate-y-full"} `}
    >
