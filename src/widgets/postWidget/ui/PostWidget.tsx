      ...
      <div>
        ...
        <div className="flex flex-row gap-9">
          <p className="flex flex-row items-center gap-1">
            <CalendarIcon className="size-5 dark:text-amber-300" />
            <span className="text-sm">2025-10-13</span>
          </p>
          <p className="flex flex-row items-center gap-1">
            <CategoryIcon className="size-5 dark:text-amber-300" />
            <span className="text-sm">Category</span>
          </p>
          <p className="hidden flex-row items-center gap-1 md:flex">
            <TagIcon className="size-5 dark:text-amber-300" />
